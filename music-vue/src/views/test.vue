<template>
  <div id="puzzle" ref="puzzle" style="display:inline-block;">
    <div class="puzzle-container" :style="'padding:' + 5*scale + 'px ' + 5*scale + 'px ' + 5*scale + 'px;border-radius:'+16*scale+'px;'">
      ...
      <div class="re-btn" @click="refreshImg" :style="'height: '+28*scale+'px;padding: '+1*scale+'px '+16*scale+'px;font-size: '+18*scale+'px;'"><a type="redo"/></div>
    </div><br>
    <div class="slider-container" :style="'width:' + dataWidth + 'px;'">
      ...
      <div class="slider-btn" ref="sliderBtn" @mousedown="startMove" @touchstart="startMove" :style="'top: '+ -7*scale + 'px;'"><a type="pause-circle" theme="twoTone" twoToneColor="#52c41a" :style="'font-size: '+44*scale+'px;'" /></div>
    </div>
  </div>
</template>
...
export default {
  ...
  props: {
    ...
    puzzleImgList: {
      type: Array,
      default: () => [
        'http://127.0.0.1:3001/imgs/test1.jpg',
        'http://127.0.0.1:3001/imgs/test1.jpg',
        'http://127.0.0.1:3001/imgs/test3.jpg',
        'http://127.0.0.1:3001/imgs/test4.jpg',
        'http://127.0.0.1:3001/imgs/test5.jpg',
        'http://127.0.0.1:3001/imgs/test6.jpg',
        'http://127.0.0.1:3001/imgs/test7.jpg',
        'http://127.0.0.1:3001/imgs/test8.jpg',
        'http://127.0.0.1:3001/imgs/test9.jpg',
        'http://127.0.0.1:3001/imgs/test10.jpg',
      ]
    },
    PlSize: {
      type: [String, Number],
...
.puzzle-container{position:relative;padding:5px 5px 5px;border:1px solid #ddd;background:#f2ece1;border-radius:16px}
